...
If you want a solution that preserve the behavior at $0$, we need,

$$
D^2y_c+4Dy_c+3y_c = 9tu(t) - 28tu(t) - 21t^2u(t)
$$

Now the right han be solved using our previous method, so,

$$
y_c = \overline{y}(t) + y^*(t)
$$

We can safely conclude,

$$
y = \overline{y}(t) + y^*(t) +u(t)-3tu(t)+7t^2u(t)
$$
