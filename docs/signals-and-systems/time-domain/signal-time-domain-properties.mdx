...
However, consider the discreet signal,
...
The $T$ doesn't guarantee to be $\frac{2\pi}{\omega}$. This is because in discreet signal, the minimum value of $T$ is one instead of zero.
